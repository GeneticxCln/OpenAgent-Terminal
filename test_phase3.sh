#!/bin/bash
# Phase 3 Integration Test - Block Rendering with Syntax Highlighting

set -e

echo "🧪 OpenAgent-Terminal Phase 3 Integration Test"
echo "=============================================="
echo "Testing: Block Detection + Syntax Highlighting"
echo ""
...
echo -e "${BLUE}🦀 Running Rust frontend with block rendering test...${NC}"
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [ $FRONTEND_EXIT -eq 0 ]; then
    ...
    echo "  ✅ Block detection working"
    echo "  ✅ Syntax highlighting working"
    echo "  ✅ ANSI colors rendering"
    echo ""
    echo "Next: Phase 4 - Tool Integration & Approval Flow"
    exit 0
else
    echo -e "${RED}❌ Phase 3 Integration Test FAILED${NC}"
    exit 1
fi
