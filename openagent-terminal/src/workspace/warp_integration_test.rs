...
fn test_warp_actions_uninitialized() {
    ...
    let mut workspace = WorkspaceManager::with_warp(
        WorkspaceId(0),
        config,
        size_info,
        None,
...
fn test_warp_actions() {
    ...
    assert_eq!(Action::FocusNextPane.to_warp_action(), Some(WarpAction::NavigatePane(WarpNavDirection::Right)));
...
fn test_config_validation() {
    ...
    let workspace_config = super::WorkspaceConfig::default();
...
fn test_config_integration() {
    ...
    let warp_workspace = WorkspaceManager::with_warp(
        WorkspaceId(1),
        warp_config,
        test_size_info(),
        None,
