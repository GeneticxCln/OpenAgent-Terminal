...
impl Default for IdeConfig {
    fn default() -> Self {
        ...
        language_servers.insert(
            "rust".into(),
            LanguageServerCommand { command: "rust-analyzer".into(), args: vec![], initialization_options: None },
        );
        language_servers.insert(
            "typescript".into(),
            LanguageServerCommand { command: "typescript-language-server".into(), args: vec!["--stdio".into()], initialization_options: None },
        );
        language_servers.insert(
            "python".into(),
            LanguageServerCommand { command: "pyright-langserver".into(), args: vec!["--stdio".into()], initialization_options: None },
        );
