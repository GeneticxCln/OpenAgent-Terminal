...
use crate::text_shaping::integration::{
    IntegratedTextShaper, ShapedLine, ShapedCell, ShapedCellGlyph, ShapedTextRenderer,
...
impl WgpuShapedTextRenderer {
    ...
    pub fn new(
        ...
        let vertex_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            ...
            size: (render_config.max_vertices_per_batch * mem::size_of::<ShapedTextVertex>()) as u64,
    ...
    fn create_render_pipeline(
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../shaders/shaped_text.wgsl"))),
        });
