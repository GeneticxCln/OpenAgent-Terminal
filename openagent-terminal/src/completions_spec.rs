...
static SPECS: Lazy<HashMap<&'static str, CommandSpec>> = Lazy::new(|| {
    ...
    m.insert(
        ...
        CommandSpec {
            ...
            subcommands: &[
                ...
                "merge", "pull", "push", "rebase", "remote", "reset", "restore", "status",
                "switch", "tag",
            ],
        },
    );
    ...
    m.insert(
        ...
        CommandSpec {
            ...
            flags: DOCKER_FLAGS,
            subcommands: &[
                "build", "compose", "cp", "create", "exec", "images", "info", "inspect", "kill",
                "logs", "network", "ps", "pull", "push", "restart", "rm", "rmi", "run", "start",
