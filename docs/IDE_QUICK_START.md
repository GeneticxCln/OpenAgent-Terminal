...
- LSP in editor overlay:
  ...
  - Hover info: Ctrl+K; Signature help: auto on '('
  - Formatting: Ctrl+Shift+F
  - Diagnostics: underlines with severity colors
- DAP overlay: Ctrl+Shift+D to toggle; L to Launch (codelldb); keys: F9 toggle breakpoint (at current editor cursor line), F5 Continue, F10 Step Over, F11 Step In, Shift+F11 Step Out; shows stack and variables when stopped
